    ...
    <div class="swiper-container">
        <div>
            ...
            <section class="islands">
                <img
                    src="{{ asset('frontend/assets/img/cons1.jpg') }}"
                    alt=""
                    class="islands__bg"
                />
            ...
            <div class="swiper-wrapper">
                @foreach($project_packages as $project_package)
                    <article class="popular__card swiper-slide">
                        <a href="{{ route('project_package.show', $project_package->slug) }}" class="text-decoration-none"> <!-- Tambahkan kelas text-decoration-none di sini -->
                            <img
